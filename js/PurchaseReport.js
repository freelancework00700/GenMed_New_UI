app.controller('PurchaseReportController', function ($scope, $rootScope, $http, $ionicPopup, $ionicLoading, $localstorage, $state, $compile) {
    ...
    $scope.FilterData = function () {
        $('#PurchaseReportTable').dataTable().api().ajax.reload();
    }
    ...
    function InitDataTable() {
        ...
        $('#PurchaseReportTable').DataTable({
            ...
            "aaSorting": [2, 'DESC'],
            "ajax": {
                url: $rootScope.RoutePath + 'purchasereport/GetAllPurchaseDynamic',
                data: function (d) {
    ...
    $scope.Export = function () {
        ...
        window.location = $rootScope.RoutePath + "report/ExportPurchaseReport" + Param;
    }

    $scope.ExportGSTPurchase = function () {
        var ObjAdvanceSearch = $scope.modelAdvanceSearch != null ? JSON.stringify($scope.modelAdvanceSearch) : '';
        var CurrentOffset = $scope.CurrentOffset;
        var idLocations = $scope.IsAdmin ? "" : $localstorage.get('idLocations');
        var Param = "?ObjAdvanceSearch=" + ObjAdvanceSearch + "&CurrentOffset=" + CurrentOffset + "&idLocations=" + idLocations;
        window.location = $rootScope.RoutePath + "report/ExportGSTPurchaseReport" + Param;
    }
    // Alias
