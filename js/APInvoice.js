app.controller('APInvoiceController', function ($scope, $rootScope, $localstorage, $compile) {
    ...
    $scope.FilterData = function () {
        $('#APInvoiceTable').dataTable().api().ajax.reload();
    }
    ...
    function InitDataTable() {
        if ($.fn.DataTable.isDataTable('#APInvoiceTable')) {
            $('#APInvoiceTable').DataTable().destroy();
        }
        $('#APInvoiceTable').DataTable({
            ...
            "aaSorting": [2, 'DESC'],
            "ajax": {
                url: $rootScope.RoutePath + 'apinvoice/GetAllAPInvoiceDynamic',
                data: function (d) {
            ...
            "columns": [
                ...
                { "data": "APInvoiceDate", "defaultContent": "N/A" },
