app.controller('UOMController', function ($scope, $rootScope, $http, $ionicPopup, $ionicLoading, $localstorage, $state) {
    ...
    $scope.GetAllUOM = function () {
        $http.get($rootScope.RoutePath + 'uom/GetAllUom').then(function (res) {
            $scope.lstUOM = res.data.data;
            $scope.TotalRecord = $scope.lstUOM.length;
    ...
    $scope.SaveUOM = function (FormUOM) {
        ...
        if (FormUOM.$valid) {
            ...
            $http.post($rootScope.RoutePath + 'uom/SaveUom', $scope.model)
                .then(function (res) {
    ...
    $scope.DeleteUOM = function (id) {
        ...
        confirmPopup.then(function (res) {
            if (res) {
                ...
                $rootScope.ShowLoader();
                $http.get($rootScope.RoutePath + 'uom/DeleteUom', {
                    params: params
